...
| skills | 呼び出し時のみロード | 縦切り実装手順、Issue 駆動 Git 手順 |
...
.claude/
  ...
  skills/{vertical-slice,issue-driven}/SKILL.md
  workflows/exhaustive-review.js  多角レビューのダイナミックワークフロー (/exhaustive-review)
scripts/hooks/{guard-bash,post-edit-check,verify-stop}.sh
.github/release.yml               リリースノート自動生成のカテゴリ設定
.github/workflows/
